...
const NoPageFound = () => {
    return (
        ...
        <section className="">
            <div className="container flex items-center py-10 px-6 mx-auto">
                <div className="flex flex-col items-center max-w-sm mx-auto text-center">
                    <p className="p-3 text-sm font-medium text-blue-500 rounded-full  dark:bg-gray-800">
                    ...
                    <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                        <Link to='/' className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-white transition-colors duration-200bg-white border rounded-lg gap-x-2 sm:w-auto   dark:border-gray-700 bg-[var(--themeColor)]">
