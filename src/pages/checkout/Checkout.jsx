                    ...
                    <div className="bg-gradient-to-r from-[#6D613B] to-[#D3BB71] lg:h-screen lg:sticky lg:top-0">
                        <div className="relative h-full">
                            ...
                            <div className="lg:absolute left-0 bottom-0 bg-[var(--bgColorPrimary)] w-full p-4">
                                ...
                                <h4 className="flex flex-wrap gap-4 text-base text-white">Shipping Fee (+) <span className="ml-auto">₹ {totalCartAmount < 399 ? shippingFee : 'FREE'}</span></h4>
                                <h4 className="flex flex-wrap gap-4 text-xl font-bold text-white">Total <span className="ml-auto text-xl">₹{Math.round(totalCartAmount + (totalCartAmount < 399 ? shippingFee : 0)) || 0}</span></h4>
                            </div>
                        </div>
                    </div>
                    {/* right side  */}
