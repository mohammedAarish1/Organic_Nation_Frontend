                ...
                <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4   ">
                    ...
                    <div className='flex flex-col gap-3  md:pb-0 pb-4'>
                        ...
                        <ul className='flex flex-col gap-1'>
                            ...
                            <li><Link to="termsandconditions"> <span className="flex items-center gap-2 max-w-max cursor-pointer hover:text-orange-500 hover:translate-x-1 transition-all duration-300 tracking-widest"><FaAnglesRight />Terms & Conditions</span></Link></li>
