...
const CartNotification = () => {
  ...
  const handleRemoveItem = useCallback((nameUrl) => {
    dispatch(removeFromCart(nameUrl))
      .then(() =>
      ...
      <AnimatePresence>
        {isCartNotificationVisible && (
          <>
            ...
            <motion.div
              className={`fixed z-50 flex flex-col shadow-2xl ${isMobile
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  background: 'linear-gradient(to right, var(--background-color), var(--neutral-color))'
                }}
              >
                <motion.div
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-75">{cartItemsList.length > 0 ? `${cartItemsList.reduce((total, item) => total + item.quantity, 0)} items added` : "No items added"}</p>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-4">
                    {cartItemsList.map((item, index) => (
                      <motion.li
                        ...
                        style={{
                          backgroundColor: index % 2 === 0 ? 'rgba(220, 210, 192, 0.3)' : 'rgba(220, 210, 192, 0.15)',
